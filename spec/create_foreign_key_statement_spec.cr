...
describe LuckyMigrator::CreateForeignKeyStatement do
  it "generates correct sql" do
    ...
    statement = LuckyMigrator::CreateForeignKeyStatement.new(:comments, :users, column: :author_id, primary_key: :uid).build
    statement.should eq "ALTER TABLE comments ADD CONSTRAINT comments_user_id_fk FOREIGN KEY (user_id) REFERENCES users (uid);"
  end
end
